...
async function updateWeather() {
    ...
    const errorElement = weatherElement.querySelector<HTMLParagraphElement>(".errorDetails .message")!;
    ...
    try {
        ...
        const [status, data] = [request.status, await request.json() as WeatherData];
